    ...
    <div class="py-5 mt-5">
        <div class="container col-8">
            <div class="d-flex justify-content-between pt-5 pb-3">
                <h5 class="fw-bold">Edit Metode Pembayaran</h5>
            ...
            <div class="bg-white p-5 border">
                <form method="post" action="<?php echo base_url('admin/update_payment/' . $payment->id); ?>"
                    enctype="multipart/form-data">
                    <div class="mb-3">
                        <label class="form-label fw-bold">Nomor Rekening
                            <span class="text-danger">*</span>
                        </label>
                        <input type="number" class="form-control" name="number" value="<?= $payment->number ?>"
                            required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="admin" value="<?= $payment->admin ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Logo Layanan Bank :
                        </label> <a target="_blank" href="<?= base_url('assets/img/bank/' . $payment->image) ?>">Gambar
                            Sebelumnya</a>
