...
<head>
    ...
    <title>Admin LoveBuddy.id | Pembayaran </title>
    <!-- SweetAlert2 CSS -->
                ...
                <table id="example" class="table display">
                    <thead>
                        <tr">
                            ...
                            <th class="text-center" scope="col">Jumlah Sesi</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2 justify-content-center">
                                        <?php echo anchor('admin/edit_feature/' . $row->id, "<button class='btn btn-primary bg-first border-0'>Edit</button>"); ?>
                                        <button onclick="return confirm('Do you want delete this record')"
                                            class="btn btn-danger">
                                            <?php echo anchor('admin/delete_feature/' . $row->id, "<span class='text-white border-0 text-decoration-none'>Hapus</span>"); ?>
                                        </button>
                                    </div>
                                </td>
                            </tr>
