    ...
    <div class="py-5 mt-5">
        <div class="container col-8">
            <div class="d-flex justify-content-between pt-5 pb-3">
                <h5 class="fw-bold">Tambah Paket Layanan</h5>
            ...
            <div class="bg-white p-5 border">
                <form method="post" action="<?php echo base_url('admin/feature_save'); ?>">
                    <div class="mb-3">
                        <label class="form-label fw-bold">Jumlah sesi
                            <span class="text-danger">*</span>
                        </label>
                        <input type="number" class="form-control" name="session_count" placeholder="3" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="service" placeholder="Chat/Voice Call/Video Call"
                            required>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="duration" placeholder="1 Sesi 60 menit" required>
                    </div>
