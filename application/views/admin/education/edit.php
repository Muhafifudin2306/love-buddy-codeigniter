    ...
    <div class="py-5 mt-5">
        <div class="container">
            ...
            <div class="bg-white p-5 border">
                <form method="post" action="<?php echo base_url('admin/update_education/' . $education->id); ?>">
                    <div class="mb-3">
                        <label class="form-label fw-bold">Strata
                            <span class="text-danger">*</span>
                        </label>
                        <input type="text" class="form-control" name="state" value="<?= $education->state ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Bidang Keilmuan
                            <span class="text-danger">*</span>
                        </label>
                        <input type="text" name="field" class="form-control" value="<?= $education->field ?>" required>
                    </div>
                    <div class="mb-3">
