    ...
    <div class="py-5 mt-5">
        <div class="container">
            <div class="d-flex justify-content-between pt-5 pb-3">
                <h5 class="fw-bold">Tambah Education</h5>
            ...
            <div class="bg-white p-5 border">
                <form method="post" action="<?php echo base_url('admin/education_save'); ?>">
                    <div class="mb-3">
                        <label class="form-label fw-bold">Strata
                            <span class="text-danger">*</span>
                        </label>
                        <input type="text" class="form-control" name="state" placeholder="S1/S2/S3" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Bidang Keilmuan
                            <span class="text-danger">*</span>
                        </label>
                        <input type="text" name="field" class="form-control" placeholder="Ilmu xxx" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Instansi
                            <span class="text-danger">*</span>
                        </label>
                        <input type="text" name="university" class="form-control" placeholder="Universitas xxx"
                            required>
                    </div>
