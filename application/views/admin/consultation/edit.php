    ...
    <div class="py-5 mt-5">
        <div class="container">
            <div class="d-flex justify-content-between pt-5 pb-3">
                <h5 class="fw-bold">Edit Data Consultation</h5>
            ...
            <div class="bg-white p-5 border">
                <form method="post" action="<?php echo base_url('admin/update_talent/' . $talent->id); ?>"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" value="<?= $talent->name ?>" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select style="width: 100%" class="js-example-basic-multiple" name="category[]" multiple
                            ...
                            <?php foreach ($categories as $row) { ?>
                                <option value="<?php echo $row->id; ?>" <?php if (in_array($row->id, explode(',', $detail_category->category_ids)))
                    ...
                    <div class="mb-3">
                        ...
                        <select style="width: 100%" class="js-example-basic-multiple" name="service[]" multiple
                            ...
                            <?php foreach ($services as $row) { ?>
                                <option value="<?php echo $row->id; ?>" <?php if (in_array($row->id, explode(',', $detail_service->service_ids)))
                                       echo 'selected'; ?>><?php echo $row->name; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="number" name="experience" class="form-control" value="<?= $talent->experience ?>"
                            required>
                    </div>
                    <div class="mb-3">
                        ...
                        <select style="width: 100%" class="js-example-basic-multiple" name="education[]" multiple
                            ...
                            <?php foreach ($educations as $row) { ?>
                                <option value="<?php echo $row->id; ?>" <?php if (in_array($row->id, explode(',', $detail_education->education_ids)))
                                       echo 'selected'; ?>><?php echo $row->state . " " . $row->field . " " . $row->university; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" name="summary" class="form-control" value="<?= $talent->summary ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Quote
                            <span class="text-danger">*</span>
                        </label>
                        <input type="text" name="quote" class="form-control" value="<?= $talent->quote ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Nomor Izin Praktek
                            <span class="text-danger">*</span>
                        </label>
                        <input type="text" name="nip" class="form-control" value="<?= $talent->nip ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Link Video Intro
                            <span class="text-danger">*</span>
                        </label>
                        <input type="text" name="video" class="form-control" value="<?= $talent->video ?>" required>
                    </div>
                    <button type="submit" class="btn btn-primary bg-first border-0">Update Data</button>
                </form>
            </div>
        </div>
    </div>
