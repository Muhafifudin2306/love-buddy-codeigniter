    ...
    <div class="py-5 mt-5">
        <div class="container">
            <div class="d-flex justify-content-between pt-5 pb-3">
                <h5 class="fw-bold">Tambah Category</h5>
            ...
            <div class="bg-white p-5 border">
                <form method="post" action="<?php echo base_url('admin/category_save'); ?>">
                    <div class="mb-3">
                        <label class="form-label fw-bold">Nama Kategori
                            <span class="text-danger">*</span>
                        </label>
                        <input type="text" class="form-control" name="name" placeholder="Keluarga/Percintaan/Seksual"
                            required>
                    </div>
